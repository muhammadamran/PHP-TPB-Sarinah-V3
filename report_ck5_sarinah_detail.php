                ...
                <div class="table-responsive">
                    <table border=0 cellpadding=0 cellspacing=0 width=1038 class=xl6911096 style='border-collapse:collapse;table-layout:fixed;width:100%'>
                        ...
                        <tr height=17 style='height:12.75pt'>
                            ...
                            <td class=xl12511096 colspan=3 style="background: red;">03 April 2018 ??? Tanggal Aju</td>
                        ...
                        <tr height=18 style='mso-height-source:userset;height:13.5pt'>
                            ...
                            <td class=xl12511096 colspan=3 style="background: red;">03 April 2018 ??? Tgl Pendaftaran</td>
                            <td class=xl6911096></td>
                            <td class=xl6911096></td>
                            <td class=xl7511096></td>
                            <td class=xl6911096></td>
                        ...
                        <tr height=18 style='mso-height-source:userset;height:13.5pt'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;width: 90px;" name="InputJenisBarangKenaCukai" id="IDJenisBarangKenaCukai">
                                    <option>-- Pilih --</option>
                        ...
                        <tr height=17 style='height:12.75pt'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;width: 90px;" name="InputCaraPelunasan">
                                    <option>-- Pilih --</option>
                        ...
                        <tr height=17 style='height:12.75pt'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;width: 90px;" name="InputStatusCukai">
                                    <option>-- Pilih --</option>
                        ...
                        <tr height=17 style='height:12.75pt'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;width: 90px;" name="InputJenisPemberitahuan" id="IDJenisPemberitahuan">
                                    <option>-- Pilih --</option>
                        ...
                        <tr height=21 style='mso-height-source:userset;height:15.75pt'>
                            ...
                            <td class=xl7611096>:</td>
                            <td colspan=5 class=xl7511096 style="background: red;">0404.2.2.1001 ???</td>
                            <td class=xl6911096></td>
                            <td class=xl6911096></td>
                            <td class=xl6911096></td>
                            <td class=xl6911096></td>
                            ...
                            <td class=xl6911096></td>
                            <td class=xl7611096>:</td>
                            <td class=xl6911096 colspan=2 style="background: red;">0501.4.2.0042 ???</td>
                            <td class=xl6911096></td>
                            <td class=xl6911096></td>
                            <td class=xl6911096></td>
                            <td class=xl7711096>&nbsp;</td>
                        ...
                        <tr height=25 style='mso-height-source:userset;height:18.75pt'>
                            ...
                            <td class=xl6911096 colspan=2>
                                <select style="border: transparent;width: 215px;" name="InputNamaKodeNegaraTujuan">
                        ...
                        <tr height=24 style='mso-height-source:userset;height:18.0pt'>
                            ...
                            <td class=xl6911096>:</td>
                            <td class=xl6911096 colspan=2>
                                <select style="border: transparent;width: 215px;" name="InputNamaKodeNegaraTujuan" id="IDNamaKodeNegaraTujuan" onchange="showAddress(this.value)">
                        ...
                        <tr height=23 style='mso-height-source:userset;height:17.25pt'>
                            ...
                            <td class=xl6911096></td>
                            <td class=xl6911096>:</td>
                            <td class=xl6911096 colspan=2 id="show-address-identitas-two"></td>
                            <td class=xl6911096></td>
                            <td class=xl6911096></td>
                            <td class=xl6911096></td>
                            <td class=xl7711096>&nbsp;</td>
                        ...
                        <tr height=24 style='mso-height-source:userset;height:18.0pt'>
                            ...
                            <td class=xl6911096>:</td>
                            <td class=xl6911096 colspan=2>
                                <select style="border: transparent;width: 215px;" name="InputNamaKodeOne" id="IDNamaKodeOne" onchange="showKodeOne(this.value)">
                        ...
                        <tr height=25 style='mso-height-source:userset;height:18.75pt'>
                            ...
                            <td class=xl6911096>:</td>
                            <td class=xl6911096 colspan=2>
                                <select style="border: transparent;width: 215px;" name="InputPelabuhanMuat" id="IDPelabuhanMuat">
                        ...
                        <tr height=21 style='mso-height-source:userset;height:15.75pt'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;width: 80px;" name="InputCaraPengangkutan">
                                    <option>-- Pilih --</option>
                            ...
                            <td class=xl6911096>:</td>
                            <td class=xl6911096 colspan=2>
                                <select style="border: transparent;width: 215px;" name="InputamaKodeTwo" id="IDNamaKodeTwo" onchange="showKodeTwo(this.value)">
                                    <option>-- Kantor Pabean --</option>
                                    <?php
                        ...
                        <tr height=25 style='mso-height-source:userset;height:18.75pt'>
                            ...
                            <td class=xl6911096>:</td>
                            <td class=xl6911096 colspan=2>
                                <select style="border: transparent;width: 215px;" name="InputPelabuhanSinggahTerakhir" id="IDPelabuhanSinggahTerakhir">
                                    <option>-- Pelabuhan --</option>
                                    <?php
                        ...
                        <tr height=24 style='mso-height-source:userset;height:18.0pt'>
                            ...
                            <td class=xl6911096>:</td>
                            <td class=xl6911096 colspan=2>
                                <select style="border: transparent;width: 215px;" name="InputamaKodeThree" id="IDNamaKodeThree" onchange="showKodeThree(this.value)">
                                    <option>-- Kantor Pabean --</option>
                                    <?php
                        ...
                        <tr height=19 style='mso-height-source:userset;height:14.25pt'>
                            ...
                            <td>
                                <select style="border: transparent;width: 90px;" name="InputPembayaran">
                                    <option>-- Pilih --</option>
                        ...
                        <tr height=17 style='height:12.75pt'>
                            ...
                            <td>
                                <select style="border: transparent;width: 90px;" name="InputJaminan" id="IDJaminan">
                                    <option>-- Pilih --</option>
                        ...
                        <tr height=17 style='height:12.75pt'>
                            ...
                            <td class=xl6911096 colspan=4 style='border-right:.5pt solid black'>:
                        ...
                        <tr height=17 style='height:12.75pt'>
                            ...
                            <td class=xl7611096>:</td>
                            <td colspan=6 class=xl7511096 style="background: red;">0404.2.2.1001 ???</td>
                    ...
                    <table border=0 cellpadding=0 cellspacing=0 width=695 class=xl6912727 style='border-collapse:collapse;table-layout:fixed;width:100%'>
                        ...
                        <tr height=19 style='height:14.25pt'>
                            <td class=xl7112727 colspan=10 style="border-right: 0.5pt solid black;border-left: 0.5pt solid black;">
