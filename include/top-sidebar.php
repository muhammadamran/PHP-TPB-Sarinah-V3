	...
	<ul class="nav">
		...
		<li class="has-sub
			...
			<ul class="sub-menu">
				...
				<li class="<?= $uriSegmentsTop[1] == 'report_data_tpb.php' ? 'active' : '' ?>" style="display: <?= $resultRoleModules['re_data_tpb']; ?>;"><a href="report_data_tpb.php">Data TPB</a></li>
				<li class="<?= $uriSegmentsTop[1] == 'report_ck5_plb.php' ? 'active' : '' ?>" style="display: <?= $resultRoleModules['re_ck_plb']; ?>;"><a href="report_ck5_plb.php">PLB CK5</a></li>
				...
				<li class="<?= $uriSegmentsTop[1] == 'report_log_system.php' ? 'active' : '' ?>" style="display: <?= $resultRoleModules['re_log']; ?>;"><a href="report_log_system.php">Log System</a></li>
			</ul>
		</li>
	</ul>
	<!-- end nav -->
