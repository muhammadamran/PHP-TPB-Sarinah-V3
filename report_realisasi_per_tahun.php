...
if (isset($_GET['find_TahunAju'])) {
    ...
    $InputDescription     = $me . " Lihat Laporan Realisasi Mitra Tahun: " .  $WGetTahunAju .", Simpan Data Sebagai Report Laporan Realisasi";
    $InputAction          = 'Laporan Mitra Per Tahun';
...
<div id="content" class="nav-top-content">
	<div class="page-title-css">
		...
		<div>
			<a href="#modal-laporan-realisasi-per-tahun" class="btn btn-primary-css" data-toggle="modal" title="Lihat Daftar Per Mitra"><i class="fas fa-search"></i> Lihat Daftar Mitra Per Tahun Lainnya</a>
			<div class="modal fade" id="modal-laporan-realisasi-per-tahun">
			    <div class="modal-dialog">
			        <div class="modal-content">
			            <form action="report_realisasi_per_tahun.php" method="GET">
			...
			<div class="panel panel-inverse" data-sortable-id="ui-perusahaan">
				<div class="panel-body text-inverse">
                    ...
                    <div class="button-top-table">
                        <form action="export/excel_report_realisasi_per_tahun.php" method="GET">
