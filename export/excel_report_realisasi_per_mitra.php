...
header("Content-Disposition: attachment; filename=Laporan Realisasi Mitra $shoWGetNamaCompany Tahun $WGetTahunAju _$datenow.xls");
...
<div>
	...
	<div class="title-laporan" style="justify-content: center;text-align: center;align-items: center;display: grid;">
		<font style="font-size: 20px;text-transform: uppercase;font-weight: 900;">LAPORAN REALISASI MITRA <br> <?= $shoWGetNamaCompany ?> Tahun <?= $WGetTahunAju ?></font>
		<br>
