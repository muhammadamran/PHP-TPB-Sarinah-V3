                ...
                <div class="table-responsive">
                    <table border=0 cellpadding=0 cellspacing=0 width=1038 class=xl6911096 style='border-collapse:collapse;table-layout:fixed;width:100%'>
                        ...
                        <tr height=18 style='mso-height-source:userset;height:13.5pt;background: yellow;'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;background: transparent;width: 90px;" name="InputJenisBarangKenaCukai" id="IDJenisBarangKenaCukai">
                                    <option>-- Pilih --</option>
                        ...
                        <tr id="OthersJenisBarangKenaCukai" height=18 style='mso-height-source:userset;height:13.5pt;background: yellow;display: none;'>
                        ...
                        <tr height=17 style='height:12.75pt;background: yellow;'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;background: transparent;width: 90px;" name="InputCaraPelunasan">
                                    <option>-- Pilih --</option>
                        ...
                        <tr height=17 style='height:12.75pt;background: yellow;'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;background: transparent;width: 90px;" name="InputStatusCukai">
                                    <option>-- Pilih --</option>
                        ...
                        <tr height=17 style='height:12.75pt;background: yellow;'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;background: transparent;width: 90px;" name="InputJenisPemberitahuan" id="IDJenisPemberitahuan">
                                    <option>-- Pilih --</option>
                        ...
                        <!-- Show Jenis Barang Kena Cukai -->
                        <tr id="OthersJenisPemberitahuan" height=18 style='mso-height-source:userset;height:13.5pt;background: yellow;display: none;'>
                            <td height=18 class=xl7811096 style='height:13.5pt'></td>
                            <td class=xl6911096>Lainnya</td>
                            <td class=xl7611096>:</td>
                            <td colspan=10>
                        ...
                        <tr height=25 style='mso-height-source:userset;height:18.75pt'>
                            ...
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl8511096 style="background: yellow" style='border-left:none'>15.</td>
                            <td class=xl6911096 style="background: yellow" colspan=4>Nama Kode Negara Tujuan</td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2>
                                <select style="border: transparent;background: transparent;width: 215px;" name="InputNamaKodeNegaraTujuan">
                                    <option>-- Nama Kode Negara Tujuan --</option>
                                    <?php
                                    $resultNamaKodeNegaraTujuan = $dbcon->query("SELECT * FROM referensi_negara ORDER BY KODE_NEGARA ASC");
                                    foreach ($resultNamaKodeNegaraTujuan as $rowNamaKodeNegaraTujuan) {
                                    ?>
                                        <option value="<?= $rowNamaKodeNegaraTujuan['KODE_NEGARA'] ?> - <?= $rowNamaKodeNegaraTujuan['URAIAN_NEGARA'] ?>"><?= $rowNamaKodeNegaraTujuan['KODE_NEGARA'] ?> - <?= $rowNamaKodeNegaraTujuan['URAIAN_NEGARA'] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl7711096 style="background: yellow">&nbsp;</td>
                        </tr>
                        <tr height=24 style='mso-height-source:userset;height:18.0pt'>
                            ...
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow" colspan=4>a. Identitas (NPPBKC/NPP/NPWP)</td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2>
                                <select style="border: transparent;background: transparent;width: 215px;" name="InputNamaKodeNegaraTujuan" id="IDNamaKodeNegaraTujuan" onchange="showAddress(this.value)">
                                    <option>-- NPPBKC/NPP/NPWP --</option>
                                    <option value="NPPBKC">NPPBKC</option>
                                    <option value="NPP">NPP</option>
                                    <?php
                                    $resultIdentitasTwo = $dbcon->query("SELECT NPWP,NAMA FROM referensi_pengusaha WHERE NPWP!='' ORDER BY ID ASC");
                                    foreach ($resultIdentitasTwo as $rowIdentitasTwo) {
                                    ?>
                                        <option value="<?= $rowIdentitasTwo['NPWP'] ?>"><?= $rowIdentitasTwo['NPWP'] ?> - <?= $rowIdentitasTwo['NAMA'] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td class=xl6911096 style="background: yellow"></td>
                        ...
                        <!-- NPPBKC -->
                         <tr id="IdentitasTwoNPPBKC" height=24 style='mso-height-source:userset;height:18.0pt;display: none;'>
                            ...
                            <td class=xl7711096></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow" colspan=4>&nbsp;&nbsp;&nbsp;&nbsp;NPPBKC</td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2>
                        ...
                        <!-- NPP -->
                         <tr id="IdentitasTwoNPP" height=24 style='mso-height-source:userset;height:18.0pt;display: none;'>
                            ...
                            <td class=xl7711096></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow" colspan=4>&nbsp;&nbsp;&nbsp;&nbsp;NPP</td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2>
                        ...
                        <tr height=23 style='mso-height-source:userset;height:17.25pt'>
                            ...
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow" colspan=3>b. Nama Alamat</td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2 id="show-address-identitas-two"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl7711096 style="background: yellow">&nbsp;</td>
                        ...
                        <tr height=24 style='mso-height-source:userset;height:18.0pt'>
                            ...
                            <td class=xl6911096></td>
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl7611096 style="background: yellow">17.</td>
                            <td class=xl6911096 style="background: yellow" colspan=3>Nama, Kode Kantor</td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2>
                                <select style="border: transparent;background: transparent;width: 215px;" name="InputNamaKodeOne" id="IDNamaKodeOne" onchange="showKodeOne(this.value)">
                                    ...
                                    <?php
                                    $resultKodeOne = $dbcon->query("SELECT * FROM referensi_kantor_pabean ORDER BY ID ASC");
                            ...
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl9111096 style="background: yellow" id="InputshowKodeOne"></td>
                        </tr>
                        <tr height=25 style='mso-height-source:userset;height:18.75pt'>
                            ...
                            <td class=xl7111096>&nbsp;</td>
                            <td class=xl7311096>&nbsp;</td>
                            <td class=xl7611096 style="background: yellow">18.</td>
                            <td class=xl6911096 style="background: yellow" colspan=3>Pelabuhan Muat</td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2>
                                <select style="border: transparent;background: transparent;width: 215px;" name="InputPelabuhanMuat" id="IDPelabuhanMuat">
                                    <option>-- Pelabuhan --</option>
                                    <?php
                                    $resultPelabuhanMuat = $dbcon->query("SELECT * FROM referensi_pelabuhan ORDER BY ID ASC LIMIT 10");
                                    foreach ($resultPelabuhanMuat as $rowPelabuhanMuat) {
                                    ?>
                                        <option value="<?= $rowPelabuhanMuat['KODE_PELABUHAN'] ?>"><?= $rowPelabuhanMuat['KODE_PELABUHAN'] ?> - <?= $rowPelabuhanMuat['URAIAN_PELABUHAN'] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td class=xl6911096 style="background: yellow"></td>
                        ...
                        <tr height=21 style='mso-height-source:userset;height:15.75pt;background: yellow;'>
                            ...
                            <td class=xl7611096>:</td>
                            <td>
                                <select style="border: transparent;background: transparent;width: 80px;" name="InputCaraPengangkutan">
                                    <option>-- Pilih --</option>
                            ...
                            <td class=xl6911096 colspan=2>
                                <select style="border: transparent;background: transparent;width: 215px;" name="InputamaKodeTwo" id="IDNamaKodeTwo" onchange="showKodeTwo(this.value)">
                                    <option>-- Kantor Pabean --</option>
                                    <?php
                                    $resultKodeTwo = $dbcon->query("SELECT * FROM referensi_kantor_pabean ORDER BY ID ASC");
                        ...
                        <tr height=25 style='mso-height-source:userset;height:18.75pt'>
                            ...
                            <td class=xl6911096></td>
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl7611096 style="background: yellow">20.</td>
                            <td class=xl6911096 style="background: yellow" colspan=4>Pelabuhan Singgah Terakhir</td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2>
                                <select style="border: transparent;background: transparent;width: 215px;" name="InputPelabuhanSinggahTerakhir" id="IDPelabuhanSinggahTerakhir">
                                    <option>-- Pelabuhan --</option>
                                    <?php
                                    $resultPelabuhanSinggahTerakhir = $dbcon->query("SELECT * FROM referensi_pelabuhan ORDER BY ID ASC LIMIT 10");
                                    foreach ($resultPelabuhanSinggahTerakhir as $rowPelabuhanSinggahTerakhir) {
                                    ?>
                                        <option value="<?= $rowPelabuhanSinggahTerakhir['KODE_PELABUHAN'] ?>"><?= $rowPelabuhanSinggahTerakhir['KODE_PELABUHAN'] ?> - <?= $rowPelabuhanSinggahTerakhir['URAIAN_PELABUHAN'] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl9311096 style="background: yellow"><span style='mso-spacerun:yes'></span></td>
                        </tr>
                        <tr height=24 style='mso-height-source:userset;height:18.0pt'>
                            ...
                            <td class=xl6911096></td>
                            <td class=xl7611096>:</td>
                            <td class=xl14111096 colspan=5 style="text-align: justify;background: red;">10 Pallet = 424 Karton ???</td>
                            <td class=xl6911096></td>
                            <td colspan=2 class=xl6911096></td>
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl7611096 style="background: yellow">21.</td>
                            <td class=xl6911096 style="background: yellow" colspan=3>Nama, Kode Kantor</td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow">:</td>
                            <td class=xl6911096 style="background: yellow" colspan=2>
                                <select style="border: transparent;background: transparent;width: 215px;" name="InputamaKodeThree" id="IDNamaKodeThree" onchange="showKodeThree(this.value)">
                                    <option>-- Kantor Pabean --</option>
                                    <?php
                                    $resultKodeThree = $dbcon->query("SELECT * FROM referensi_kantor_pabean ORDER BY ID ASC");
                                    foreach ($resultKodeThree as $rowKodeThree) {
                                    ?>
                                        <option value="<?= $rowKodeThree['KODE_KANTOR'] ?>"><?= $rowKodeThree['KODE_KANTOR'] ?> - <?= $rowKodeThree['URAIAN_KANTOR'] ?></option>
                                    <?php } ?>
                                </select>
                            </td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl6911096 style="background: yellow"></td>
                            <td class=xl9111096 style="background: yellow" id="InputshowKodeThree"></td>
                        </tr>
                        <tr height=17 style='height:12.75pt'>
                            <td height=17 class=xl8011096 style='height:12.75pt'>&nbsp;</td>
                            <td class=xl8111096>&nbsp;</td>
                        ...
                        <tr height=19 style='mso-height-source:userset;height:14.25pt'>
                            ...
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl7611096 style="background: yellow;">a.</td>
                            <td class=xl6911096 style="background: yellow;" colspan=2>Pembayaran&nbsp;:</td>
                            <td style="background: yellow;">
                                <select style="border: transparent;background: transparent;width: 90px;" name="InputPembayaran">
                                    <option>-- Pilih --</option>
                            ...
                            <td class=xl6911096 style="background: yellow;" colspan=2>1. Bank Devisa</td>
                            <td class=xl6911096 style="background: yellow;" colspan=3>2. Kantor</td>
                            <td class=xl6911096 style="background: yellow;" colspan=1 style='border-right:.5pt solid black'><span style='mso-spacerun:yes'></span>3. Kantor Pos</td>
                        </tr>
                        <tr height=17 style='height:12.75pt'>
                            <td height=17 class=xl7811096 style='height:12.75pt'>&nbsp;</td>
                            ...
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl7611096 style="background: yellow;">b.</td>
                            <td class=xl6911096 style="background: yellow;" colspan=2>Jaminan&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</td>
                            <td style="background: yellow;">
                                <select style="border: transparent;background: transparent;width: 90px;" name="InputJaminan" id="IDJaminan">
                                    <option>-- Pilih --</option>
                            ...
                            <td style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;" colspan=2>1. Tunai</td>
                            <td class=xl6911096 style="background: yellow;" colspan=3>2. Bank Garansi</td>
                            <td class=xl10511096 style="background: yellow;">3. Excise Bond</td>
                        </tr>
                        <tr height=17 style='height:12.75pt'>
                            <td height=17 class=xl7811096 style='height:12.75pt'>&nbsp;</td>
                            <td class=xl6911096></td>
                            ...
                            <td class=xl6911096></td>
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl7811096 style="background: yellow;" style='border-left:none'>&nbsp;</td>
                            <td class=xl7611096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;" colspan=2>4. Lainnya</td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl7711096 style="background: yellow;">&nbsp;</td>
                        ...
                        <tr height=17 id="OthersJaminan" style='height:12.75pt;display: none;'>
                            ...
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl7611096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;" colspan=2>Lainnya&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</td>
                            <td style="background: yellow;">
                                <input type="text" name="OthersJaminan">
                            </td>
                            <td style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;" colspan=2></td>
                            <td class=xl6911096 style="background: yellow;" colspan=3></td>
                            <td class=xl10511096 style="background: yellow;"></td>
                        </tr>
                        <!-- End Others Jaminan -->
                        <tr height=17 style='height:12.75pt'>
                            <td height=17 class=xl7811096 style='height:12.75pt'>&nbsp;</td>
                        ...
                        <tr height=17 style='height:12.75pt'>
                            ...
                            <td class=xl7811096 style="background: yellow;" style='border-left:none'>&nbsp;</td>
                            <td class=xl7611096 style="background: yellow;">c.</td>
                            <td class=xl6911096 style="background: yellow;" colspan=6>No. Bukti Pembayaran/Jaminan</td>
                            <td class=xl6911096 style="background: yellow;" colspan=4 style='border-right:.5pt solid black'>:
                                <input type="text" name="InputNoBuktiPembayaranJaminan">
                            </td>
                        </tr>
                        <tr height=17 style='height:12.75pt'>
                            <td height=17 class=xl7811096 style='height:12.75pt'>&nbsp;</td>
                            ...
                            <td class=xl7811096 style="background: yellow;" style='border-left:none'>&nbsp;</td>
                            <td class=xl7611096 style="background: yellow;">d.</td>
                            <td class=xl6911096 style="background: yellow;" colspan=6>Tanggal Bukti Pembayaran/Jaminan</td>
                            <td class=xl6911096 style="background: yellow;" colspan=4 style='border-right:.5pt solid black'>:
                                <input type="text" name="InputTanggalBuktiPembayaranJaminan">
                            </td>
                        </tr>
                        <tr height=17 style='height:12.75pt'>
                            <td height=17 class=xl7811096 style='height:12.75pt'>&nbsp;</td>
                            ...
                            <td class=xl7711096>&nbsp;</td>
                            <td class=xl7811096 style="background: yellow;" style='border-left:none'>&nbsp;</td>
                            <td class=xl7611096 style="background: yellow;">e.</td>
                            <td class=xl6911096 style="background: yellow;" colspan=3>Kode Penerimaan</td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;"></td>
                            <td class=xl6911096 style="background: yellow;" colspan=4 style='border-right:.5pt solid black'>:
                                <input type="text" name="InputKodePenerimaan">
                            </td>
                        </tr>
                        <tr height=17 style='height:12.75pt'>
                            <td height=17 class=xl7811096 style='height:12.75pt'>&nbsp;</td>
